            ...
            <div class="col-md-3">
                <div class="card card-dark">
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-lg-5">
                                <label class="section-title" for="switchdatetime">FECHA Y HORA</label>
                            </div>
                            <div class="col-lg-2 form-check form-switch" style="margin-top: 10px;">
                                <input id="switchdatetime" class="form-check-input" type="checkbox">
                            </div>
                            <div class="col-lg-5">
                                <small id="fecha-deshabilitada" class="text-danger">
                                    <i class="fas fa-lock"></i> Fecha deshabilitada
                                </small>
                                <small class="text-muted" id="fecha-habilitada" style="display: none;">
                                    <i class="fas fa-unlock text-info"></i> Fecha habilitada
                                </small>
                            </div>
                        </div>
                        <div class="row g-2">
                ...
                <div class="card card-dark">
                    <div class="card-body">
                        <div class="row g-2">
                            ...
                            <div class="col-md-1 form-check form-switch" style="margin-top: 10px;">
                        ...
                        <small class="text-muted" id="mensaje-habilitado" style="display: none;">
                            <i class="fas fa-unlock text-info"></i> Los campos están habilitados.
                        </small>
                    </div>
                </div>
            </div>
