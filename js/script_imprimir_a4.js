...
document.getElementById('btn-imprimir1').addEventListener('click', function () {
    ...
    iframe.src = 'html/print-fua-a4.html'; // Ruta del archivo HTML que contiene el diseño del FUA
