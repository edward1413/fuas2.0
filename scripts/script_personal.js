...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function realizarBusqueda(termino) {
        ...
        fetch(`buscar/buscar_personal.php?nombrePersonal=${encodeURIComponent(termino)}`)
            ...
            .then(data => {
                ...
                resultadosPersonal.classList.remove('d-none');  // Mostramos los resultados

                // Capturamos los elementos de los resultados recién generados
                currentResults = document.querySelectorAll('#resultados-personal .search-item');
